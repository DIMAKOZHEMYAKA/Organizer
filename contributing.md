...
Спасибо за интерес к вкладу в Organizer! В этом документе описаны основные правила и рекомендации для участников.
...
git clone https://github.com/DIMAKOZHEMYAKA/Organizer.git
